...
const pagesData = [
  {
    ...
    "secondaryText": {
      "spanOne": "A nossa cidade possui em sua maioria pequenos comércios, nos quais atendem clientes todos os dias de diversas comunidades.",
      "spanTwo": "Pensando em melhor atendê-los, esta página foi criada durante as restrições da pandemia do Covid-19 aqui iniciadas em Março de 2020.\n\nNosso objetivo é transformar a nossa cidade em um centro comercial digital, onde tornaremos possível o contato direto entre clientes e comércios locais, agendamentos de serviços, pedidos e consultas de informações, tudo em um só lugar e de fácil acesso.\n\nAproveitem esta oportunidade e ajude-nos a tornar a cidade cada vez mais digital."
    }
  },
  {
    "title": "Registrar",
    description: "Publique o seu anúncio na plataforma mais acessada da região.",
    "slug": "auth/register",
    "fields": {
      "title": {
        titleLabel: 'Título',
      ...
      "category": {
        ...
        categoriesList: categoriesList[0].tagsList,
